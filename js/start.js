...
window.renderStatistics = function (ctx, names, times) {
  ...
  ctx.fillText('Ура вы победили!', CLOUD_POSITION_X + GAP * 12, CLOUD_POSITION_Y + GAP * 2);
  ctx.fillText('Список результатов:', CLOUD_POSITION_X + GAP * 12, CLOUD_POSITION_Y + GAP * 5);
